<template>
  <div class="root">
    ...
    <div style="display: flex">
      ...
      <div ref="canvas" class="canvasPanel" :style="{'width':isView?'100%':'70%','border-bottom':isView?0:null}"></div>
  ...
  export default {
    ...
    methods: {
      ...
      initEvents(){
        ...
        // const height = this.height-1; // todo
        const height = window.innerHeight - 53 ;// 获取高度
        this.resizeFunc = ()=>{
    ...
    mounted() {
      ...
      if(!this.isView){
        ...
        plugins = [ this.cmdPlugin,toolbar,addItemPanel,canvasPanel,minimap,grid ];
      }
      ...
      this.graph = new G6.Graph({
        ...
        // height: this.height,
        height: window.innerHeight - 53, // 获取高度
        width: width,
        modes: {
